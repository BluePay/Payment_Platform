...
BluePayPayment_BP10Emu payment = new BluePayPayment_BP10Emu(
  ...
  MODE);
    ...
    paymentRefund.refund(payment.getTransID(), "5.00");
    try
        {
    ...
    if(paymentRefund.isError())
        {
          System.out.println("Error: " + paymentRefund.getMessage());
        }
        else if(paymentRefund.isApproved() || payment.isDeclined())
        {
